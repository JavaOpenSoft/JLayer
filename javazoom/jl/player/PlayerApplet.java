...
/**
 * A simple applet that plays an MPEG audio file. The URL (relative to the document base) is passed as the "audioURL"
 * parameter.
 *
 * @author Mat McGowan
 * @since 0.0.8
...
public class PlayerApplet extends Applet implements Runnable {
    ...
    /**
     * Retrieves the <code>AudioDevice</code> instance that will be used to sound the audio data.
     *
     ...
     *
     * @return an InputStream from which the MPEG audio data is read, or null if an error occurs.
     */
    ...
    /**
     * Decompresses audio data from an InputStream and plays it back through an AudioDevice. The playback is run on a
