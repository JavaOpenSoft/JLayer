...
/**
 * The <code>Converter</code> class implements the conversion of an MPEG audio file to a .WAV file. To convert an MPEG
 * audio stream, just create an instance of this class and call the convert() method, passing in the names of the input
 * and output files. You can pass in optional <code>ProgressListener</code> and
...
public class Converter {
    ...
    /**
     * This interface is used by the Converter to provide notification of tasks being carried out by the converter, and
    ...
    public interface ProgressListener {
        ...
        /**
         * Conversion is complete. Param1 contains the time to convert in milliseconds. Param2 contains the number of
         * MPEG audio frames converted.
         */
         ...
         *                 <p>
         *                 UPDATE_FRAME_COUNT: param1 is the frame count, or -1 if not known. UPDATE_CONVERT_COMPLETE:
         *                 param1 is the conversion time, param2 is the number of frames converted.
         */
         ...
         * to abort conversion.
         * <p>
         * If this method returns <code>false</code>, the exception is propagated to the caller of the convert() method.
         * If
